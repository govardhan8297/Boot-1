...
function displayName() {
    ...
    document.getElementById("name").innerHTML = cap_name + " Has Been Joined on " + date.getDate() + " " + monthNames[date.getMonth()] + " " + date.getFullYear() + " at " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds() + " " + am_pm;
    }
}
